...
export const ROUTE_ANIMATION = trigger('routeAnimations', [
    transition(':increment', [transitionStyle, fromBottomToTop], transitionParameters),
    transition(':decrement', [transitionStyle, fromTopToBottom], transitionParameters),
]);
